...
created: 2026-06-06
type: 专题笔记
parent_topic: AIDS 机会性感染（OI）按 CD4 分层 — 病原 / 阈值 / 对口药 / 鉴别
---

# AIDS 机会性感染按 CD4 谱

> [!info] 笔记定位
> **HIV 机会性感染（opportunistic infection, OI）的"CD4 钟表"。**
> Step 2 CK 的 HIV-OI 题 90% 靠两步秒杀：① **CD4 落在哪一档** → 锁定病原候选 → ② **再用一条鉴别钥匙**（血便 vs 水样 / 单灶 vs 多灶 / 溃疡形态）定到唯一病原 → 对口药。
> 用法：先死记 §二 CD4 分层总表 + §三预防阈值，再用 §四-六三张鉴别速查表收尾。
> 错题驱动：[[mistakes/uworld-mistakes_2026-06#^Q2268]]（MAC）+ [[mistakes/uworld-mistakes_2026-06#^Q3917]]（CMV 结肠炎）+ [[mistakes/uworld-mistakes_2026-06#^Q4938]]（播散性组织胞浆菌·CD4 80 → 尿抗原，误选淋巴结活检）。
...
Step 2：用一条鉴别钥匙定唯一病原（见 §四-六）
  ...
  CNS：多发环形→Toxo / 单发→淋巴瘤 / 不强化无占位→PML
  食管：白斑→Candida / 大线状溃疡→CMV / 小簇溃疡→HSV
```

> [!tip] 核心心法
> CD4 是"能不能得"，鉴别钥匙是"到底是哪个"。两题（MAC vs CMV）同在 CD4<50，正因如此**只能靠 Step 2 的钥匙（血 vs 水）分开**——这就是 UW 反复设的陷阱。
...
> - **200 → PCP**（"200 喘不上气"，此线起 TMP-SMX 预防）
> - **150 → 组织胞浆菌**
...
> [!info] 与 PEP 区别
> 本表是**长期一级预防**（CD4 阈值驱动），与暴露后短程 [[完整笔记/专题笔记/感染/感染_暴露后预防PEP速查]] 是两套逻辑，别混。

---

## 四、HIV 腹泻病因鉴别 ⭐（血 vs 水）

> [!danger] CD4<50 双雷区：MAC vs CMV
> 两者都 CD4<50 + 腹泻 + 体重↓，**靠大便性状分**：CMV = 血便（小量频繁）；MAC = 水样 + 高热。错题 [[mistakes/uworld-mistakes_2026-06#^Q3917]] 正是此陷阱。

| 病原 | CD4 | 腹泻特征 | 鉴别钥匙 |
|---|---|---|---|
| **Cryptosporidium 隐孢子虫** | **<100** | **重度水样**、低热、体重↓ | 大量水样、慢性（重症多见于 <50） |
| **Microsporidia / Isospora（Cystoisospora）belli** | <100 | 水样 + 腹绞痛 | **罕发热** |
| **MAC** | <50 | **水样 + 高热(>39°C)** + 体重↓ | 高热 + 血培 NTM + ALP↑ |
| **CMV 结肠炎** | <50 | **频繁、小量、血便 + 腹痛** | **血便（hematochezia）** = 唯一血性 |

> [!question]- Q：AIDS + CD4<50 + 间断血性腹泻 + 腹痛，最可能病原？
> **CMV 结肠炎**。CD4<50 的腹泻里只有 CMV 是**血性、小量频繁**；MAC/Crypto/Microsporidia 都是水样。诊断结肠镜活检（核内嗜酸 + 胞浆嗜碱包涵体），治 ganciclovir + ART，**活动性 CMV 必查视网膜炎**。
...
> [!danger] 隐球菌脑膜脑炎的两个"体外"线索 ⭐（易漏 — 派生自 Q16124）
> 隐球菌题不只考"头痛 + CrAg"，UW 还爱埋两个不在 CSF 里的钩子：
>
> **① 播散性皮损 = umbilicated papules（脐凹样丘疹），像传染性软疣 molluscum contagiosum**
> - 约 **25%** 的隐球菌病经**血行播散到皮肤** → 面/颈/躯干出现**中央脐凹的肉色/珍珠样丘疹**，形态**与 molluscum contagiosum 几乎一样**。
> - ⚠️ 陷阱：AIDS 患者出现"脐凹丘疹"**别反射答 molluscum**——若同时有**头痛 / 发热 / 神经症状 + CD4<100**，这是**播散性隐球菌病的皮肤表现**（也可以是播散性组织胞浆菌 histoplasma / 马尔尼菲篮状菌 talaromyces）。皮损本身提示"已血行播散"，不是孤立皮肤病。
> - 反过来用：AIDS + 亚急性头痛 + **脐凹皮疹** → 直接想隐球菌 → LP + India ink / CrAg。
>
> **② ↑颅压 → 展神经（CN6, abducens）麻痹 → 侧向凝视麻痹 + 复视 diplopia**
> - 机制：C. neoformans 的荚膜多糖**堵塞蛛网膜绒毛 arachnoid villi** → CSF 回流受阻 → **颅内压↑（↑ICP）** → 牵拉/压迫**颅内走行最长、最易受压的第 6 对脑神经（展神经）** → **患眼不能外展、侧视时落后 → 复视**。
> - 因此隐球菌脑膜炎经典画像 = 亚急性**头痛 + 恶心呕吐 + 意识改变（↑ICP 三联）** + **展神经麻痹/复视**（≠ 局灶占位，别误当卒中/肿瘤）。
> - 呼应处理：**反复 LP（甚至脑室引流）降颅压**是隐球菌治疗成败关键之一 —— 因为致病/致死主要来自 ↑ICP 而非药物覆盖不足。
...
> | # | 指征 | 正常值参考 | 加激素阈值 |
> |---|---|---|---|
> | 1 | **动脉血氧分压 PaO₂** | **80–100 mmHg**（室内空气）| **< 70 mmHg** |
> | 2 | **肺泡-动脉氧分压差 A-a gradient** | **< 10–15 mmHg**（年轻人；年龄校正 ≈ 年龄/4 + 4）| **≥ 35 mmHg** |
> | 3 | **脉氧 / 血氧饱和度 SaO₂** | **≥ 95%**（95–100%）| **< 92%** |
> 
...
## 八、Memory Hook（救命口诀总集）

```
CD4 钟表
  500 → 黏膜皮肤（thrush/OHL/KS/带状疱疹）
  200 → PCP（起 TMP-SMX 预防）
  150 → 组织胞浆菌
  100 → 脑 + 食管（Toxo/Crypto/食管Candida）
  50  → 最深坑（MAC/CMV/淋巴瘤/PML）
...
- 📚 主笔记：
  - [[完整笔记/Peixuan分科笔记/感染]]（HIV / 各 OI 病原章节）
  - [[完整笔记/专题笔记/感染/感染_抗生素高频20场景秒杀]]（PJP → TMP-SMX；机会性感染对口药）
  - [[完整笔记/专题笔记/感染/感染_暴露后预防PEP速查]]（长期一级预防 vs 短程 PEP 的区别）
- 🏥 跨学科：
  - [[完整笔记/Peixuan分科笔记/眼科]]（CMV 视网膜炎 pizza-pie；活动性 CMV 必查眼底）
  - [[完整笔记/Peixuan分科笔记/neuro]]（Toxo / PML / CNS 淋巴瘤 / 隐球菌脑膜炎 — 颅内病变鉴别）
  - [[完整笔记/Peixuan分科笔记/GI]]（HIV 腹泻 / 食管炎鉴别）
