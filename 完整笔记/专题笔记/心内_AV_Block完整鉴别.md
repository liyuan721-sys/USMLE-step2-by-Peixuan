...
> 另见 [[完整笔记/专题笔记/心内_AF复发与心律失常工具边界]] §Part 3 — "**Atropine 反应驱动定位 + MI 部位先验 + 非 MI 病因（Lyme/Lenegre/瓣置换术后/抗 SSA 先天性）**" 完整决策框架，整合 CSM/Adenosine/Atropine/EPS 四工具的适用边界对比。
...
- 📚 **主笔记 + 已有衍生**：
  - [[完整笔记/Peixuan分科笔记/心内]]
  - [[完整笔记/专题笔记/心内_Vaughan_Williams抗心律失常药]] **Part 7.6**（ACLS 症状性心动过缓决策树 + atropine 起效部位）/ **Part 7.6.x**（传导系统病变 7 大病因，来源 Q4456）— ⭐ 与本衍生**互补分工**：
