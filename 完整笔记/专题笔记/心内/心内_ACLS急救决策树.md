...
> [!info]- 成人 ↔ 婴儿/儿童 SVT 处理对照(框架同,手法/剂量按体重)
> **决策框架完全一样**:稳定 → 迷走 (vagal maneuvers) → 腺苷 (adenosine);不稳定 → 同步电复律 (synchronized cardioversion)。**差别只在执行细节**:
>
> | 环节 | 成人 | 婴儿 / 儿童 |
> |---|---|---|
> | **迷走手法** | 改良 Valsalva / 颈动脉窦按摩 (carotid sinus massage) | **冰敷面部 (ice to face)** 触发潜水反射;**不做** Valsalva/颈动脉按摩 |
> | **腺苷剂量** | **6 → 12 → 12 mg** 固定 | **0.1 mg/kg(max 6)→ 0.2 mg/kg(max 12)** 按体重 |
> | **电复律能量** | 50–100 J 起 | **0.5–1 J/kg → 2 J/kg** 按体重 |
> | **最常见机制** | **AVNRT (房室结折返)** | **AVRT (旁路折返, 常 WPW)** |
> | **长期管理** | 反复发作 → 导管消融 (catheter ablation) | 多数 **1 岁内自愈**,先观察/药物 |
>
> > [!danger] 婴儿迷走禁忌
> > ❌ **禁压眼球 (ocular pressure)** → 视网膜损伤(旧法已淘汰);婴儿不会配合 Valsalva、不做颈动脉窦按摩。成人颈动脉窦按摩:**有 bruit (杂音)/近期 TIA (transient ischemic attack, 短暂性脑缺血发作)-卒中**者禁(防斑块脱落)。
> >
> > 腺苷给法两者相同:**快推 + 紧跟生理盐水冲管**(半衰期 <10 秒)。
>
> 源:2026-06-18 讨论同步 → [[NBME11_错题本#^Q004]]
