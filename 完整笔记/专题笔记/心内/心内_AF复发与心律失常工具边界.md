...
> [!info] 与 [[完整笔记/专题笔记/心内/心内_AV_Block完整鉴别]] 的分工
...
- 📚 主笔记：
  ...
  - [[完整笔记/专题笔记/心内/心内_AV_Block完整鉴别]] — AV block 5 类 ECG 识别（PR/QRS 模式 + UWorld 原图）
  - [[完整笔记/专题笔记/心内/心内_抗凝抗板_急性血栓]] §E.2 AFib 长期抗凝（评分驱动抗凝面 + Trigger vs Substrate + Holiday Heart）
- 🏥 跨学科：
