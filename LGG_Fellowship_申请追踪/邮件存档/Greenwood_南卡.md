---
title: Greenwood Genetic Center（南卡罗来纳）— LGG 申请邮件存档
type: 申请邮件存档
...
- **学位要求**：doctoral degree（**MD 或 PhD 均可**），由 **ABMGG 认定**是否属合适的 basic/biological science → 你 ABMGG 已通过、正由其背书 → **符合** ✅
- **材料**：申请表（先邮件索取）+ CV + statement of intent + **3 封推荐信**（邮件版 + 签名硬拷贝寄送）
- **投递**：全程邮件
- **协调员**：Leta Tribble, PhD — lmt@ggc.org　☎️ (864) 943-4170

> [!warning] 推荐信要"电子 + 纸质"双份（官网原文：The letters can be e-mailed, but signed hard copies should also be mailed）
> 同一封推荐信，**推荐人既要 email 扫描/PDF 版**（快、先受理），**又要把手写签名的纸质原件邮寄**到 Greenwood（通常由推荐人自己寄，保密）。
> - **行动**：约推荐人时就说明"除 email 外还要寄一份签名纸质版"，**留足打印→手签→邮寄的时间**（8/1 截止，别卡最后）。
> - 用词是 **should**（非 must）→ 时间紧时可先发电子版赶 8/1、纸质随后补，但**最好先问 Leta Tribble 电子版能否先受理**。
> - ⏭️ 待拿到申请表确认**准确邮寄地址**后，把地址一并发给推荐人。
...
- **可发送 Word 版**：`Desktop\LGG报名\各学校沟通邮件\Greenwood_LGG_inquiry_email.docx`

**正文：**

> Dear Dr. Tribble,
>
> I am writing to express my strong interest in the Laboratory Genetics and Genomics (LGG) Fellowship at Greenwood Genetic Center, and to request the application form. I would also be grateful to confirm a couple of points before applying.
>
> Briefly about my background: I am a Chinese board-certified pathologist (formerly Deputy Chief Physician of Pathology at Peking Union Medical College Hospital) and hold a Doctor of Clinical Medicine degree with a subspecialty in pathology. Most recently I served as a Research Pathologist and biomedical scientist at Cedars-Sinai Medical Center (2023–2025), and I have authored 39 peer-reviewed publications, many involving molecular and genomic studies. The ABMGG Credentials Committee has completed its review and accepted my doctoral degree as satisfying the doctoral degree requirement (decision valid through 2031); the letter is attached. I am also a U.S. permanent resident and require no visa sponsorship.
>
> I would appreciate your guidance on the following:
>
> 1. Is a fellowship position available for a July 2027 start in this cycle?
> 2. Given my background and completed ABMGG credentials review, am I eligible to apply?
> 3. Could you please send me the application form and let me know of any additional required materials?
>
