...
# OET 听力 Part A 实战 01 — 哮喘问诊 (Q1–12) + IBS 问诊 (Q13–24)

> 返回 [[00_OET总览]] · 生词拼写 → [[OET_听力_默写词库]] · 通用技巧 → [[OET_听力阅读_技巧]]

> [!info] 素材与做法
> 两段 GP (general practitioner, 全科医生) 问诊（同一套 Part A 练习，来源：OET Global Fighters 样题）。做法：先盲做填空 → 对照本笔记 §答案分析 → 精听逐字稿跟读，不认识的词进 [[OET_听力_默写词库]]。转写中 D = Doctor（医生），P = Patient（患者）。
> - Extract 1：新发喘息 3 周（Mr Bloomfield）— 指向 asthma（哮喘）
> - Extract 2：4 年腹部不适（Barbara Roberts, 58 岁）— 指向 post-infectious IBS (irritable bowel syndrome, 感染后肠易激综合征) + health anxiety（健康焦虑）

---

## 一、Extract 1 — Mr Bloomfield（呼吸困难）
...
**D**: Okay. When do the attacks come on?
**P**: At any time, but they seem to be worse at night and in the morning.
**D**: Have you noticed any change in the severity of the attacks, especially in the morning?
**P**: Yeah.
**D**: Do they wake you up at night?
**P**: About three times a week.
**D**: I see. You been off work at all?
**P**: No, but I nearly didn't go in yesterday.
...
**D**: Okay. Have you had any infections recently, like flu or sore throat or chest infection?
...
**P**: No.
**D**: What about pets? Do you have pets at home?
**P**: No, but my neighbours have a cat, but I don't see it that much.
...
**P**: No, never.
**D**: Do you have other illnesses — high blood pressure, diabetes or heart problems?
...
| # | 答案 | 原文依据 | 考法 |
|---|---|---|---|
| 1 | breathing | problems with my breathing | 直接抓词 |
| 2 | coughing | I've been coughing a lot | 直接抓词 |
| 3 | phlegm | some white phlegm | 拼写陷阱：ph- + 不发音 g |
| 4 | attacks | the attacks... getting worse | 卡片用词 attacks 来自医生转述 |
| 5 | not | It's not being able to get my breath that's really worrying | 强调句转写 |
| 6 | attacks | they're much more frequent | 同一词重复考 |
| 7 | nearly | I nearly didn't go in yesterday | 副词填空，弱读易漏 |
| 8 | allergy | triggers... dust, feathers, new carpets? No | 同义转换：triggers → allergy |
| 9 | (the) mortgage | anxious what with the mortgage and that | 口语结构 what with... and that |
| 10 | never | No, never | 直接抓词 |
| 11 | ill | first time I've been ill in my life | 直接抓词 |
| 12 | eczema | Both my sister and my mother have it | 拼写陷阱：cz，无 ae |

> [!warning] Q8 是全篇最难
> 音频从头到尾没说 allergy——医生问 "anything that **triggers** the attacks?" 并列举 dust/feathers/carpets，笔记改写成 "no known **allergy** to dust"。听到 A 写 B 的同义转换是 Part A 最高级考法，靠预读时把空格前后词（"no known ___ to dust"）翻译成"要填的是某种'对尘螨的反应'类名词"来预判。

> [!tip] 临床背景（帮预判）
> 成人新发 wheezing（喘息）+ 夜间/晨起加重 + **周末缓解**（work-related pattern，occupational asthma 职业性哮喘的经典钩子）+ 家族 atopy（特应性体质）史（eczema 湿疹）→ asthma（哮喘）。工作压力（civil servant 公务员、mortgage 房贷）是心因性放大因素。USMLE 视角见 [[完整笔记/Peixuan分科笔记/pulmonary]]。

---

## 二、Extract 2 — Barbara Roberts（腹部不适 4 年）

### 2.1 完整 Transcript

（题头与患者信息播报 "Age: 58" 在录音开始前，未收录）

**D (Dr Petty)**: Barbara Roberts?
**P**: Yes.
**D**: Hello there. My name is Dr Petty. I'm one of the new GPs in the practice. First of all, what would you like me to call you?
**P**: Well, you can call me Barbara, that'll be fine.
...
| # | 答案 | 原文依据 | 考法 |
|---|---|---|---|
| 13 | discomfort | terrible discomfort nearly all the time | 直接抓词 |
| 14 | bloated | It very often feels bloated | often 位置变化（very often → often times）|
| 15 | diarrhoea | swing between being constipated and having diarrhoea | 顺序反转陷阱（见下）|
| 16 | sometimes | cramping feelings sometimes, and other times it stabs | 见下方 warning |
| 17 | four years | a holiday in Egypt about four years ago | 时间锚点 how long |
| 18 | muscle relaxants | Dr Brown gave me some muscle relaxants at the beginning | started with = at the beginning |
| 19 | Imodium | Oh, and Imodium. I have Imodium in my handbag | 商品名拼写，大写 I |
| 20 | barium enema | at the same time I had a barium enema | also administered = at the same time |
| 21 | physical | I get too much physical pain for it to be in my head | 转述压缩 |
| 22 | ulcer | I wonder if it's an ulcer | 冠词线索 an + 多干扰项（见下）|
| 23 | pleasurable things | bring back some of those pleasurable things | 直接抓词（可写 activities）|
| 24 | decide | really decide which are helping you, which are doing nothing | between ↔ which...which 句式转换 |

> [!warning] Q16 存疑，对答案时留意
> 卡片写 "cramping feeling (16) ___"。按原文顺序填 **sometimes**；如果官方 key 给 **stabbing**（把 "cramping sometimes + stabbing at other times" 压缩成一条），也说得通。两个都记。

> [!danger] Q15 顺序反转 + Q22 干扰项轰炸（本篇两大陷阱）
> - **Q15**：笔记 "swings between (15)___ and **constipation**"，但音频顺序是 "**constipated** and having **diarrhoea**"。先听到的词已印在卷子上，要填**后出现**的。预读时先圈出空格旁已给的词。
> - **Q22**：患者一口气自我怀疑 4 个诊断——infection（已印在笔记）、IBS、ulcer、cancer。两个定位钩子：① 冠词 **an** 要求元音开头 → 只有 ulcer 符合（an IBS ✗ / an cancer ✗）；② 笔记 "sometimes **wonders**" 对应音频 "I'll think, I **wonder** if it's an ulcer"。

> [!tip] 临床背景（帮预判后半篇）
> 埃及旅行急性胃肠炎 (acute gastroenteritis) 后 4 年功能性症状 + 检查全阴性 = **post-infectious IBS（感染后肠易激综合征）**；叠加 health anxiety（健康焦虑："all in my head" 冲突、mother-in-law 漏诊焦虑、自我诊断 cancer 癌症）。医生的处理是标准 biopsychosocial approach（生物-心理-社会模式）：恢复愉快活动 → 精简用药（rationalise medications）→ 2–3 个月观察期 + safety-netting（安全网策略：定期随访、症状变化再查）。听懂这个套路，医生最后两大段长 monologue（独白）的答案（Q23/24）可以提前预判。USMLE 对应 somatic symptom disorder（躯体症状障碍）的处理原则 → [[完整笔记/Peixuan分科笔记/psych]]、IBS 诊断 → [[完整笔记/Peixuan分科笔记/GI]]。

---

## 三、做题技巧总结（从这两篇提炼）

> [!success] Part A 六条实战规则
> 1. **答案严格按音频顺序出现**。手指跟笔记走，听到锚点词（how long → 准备时间题）就盯下一空。
> 2. **30 秒预读做三件事**：① 圈空格前后已给的词（防顺序反转，如 Q15 的 constipation）；② 圈冠词/单复数等语法线索（Q22 的 an → 元音开头）；③ 把笔记语言心译成"我要听什么"（no known ___ to dust → 听'过敏'类词）。
> 3. **同义转换是主考点**：triggers→allergy（Q8）、at the same time→also（Q20）、at the beginning→started with（Q18）、which...which→between（Q24）。笔记是转述，不是听写。
> 4. **干扰项轰炸时抓限定词**：患者连说 4 个自我诊断（Q22），靠 "sometimes wonders" + "an" 双重锁定。听到多个候选不要慌，回笔记找限定。
> 5. **商品名/检查名直接考拼写**：Imodium（大写 I）、barium enema、gastroscopy。药名商品名 OET 不给通用名提示。
> 6. **听懂临床套路 = 获得预判力**：Extract 1 是哮喘问诊模板（诱因排查 → 职业/心理 → 家族 atopy），Extract 2 是功能性疾病咨询模板（症状确认 → 既往检查 → 患者认知 → 新方案协商 + safety-netting）。套路熟了，长 monologue 里答案的位置可以提前猜到。
...
| 词/短语 | 中文 | 备注 |
|---|---|---|
| wheezing / wheeze | 喘息 | 新词，已入词库 |
| phlegm | 痰 | 词库已有，ph- + 不发音 g |
| chest tightness | 胸闷 | 与 pain 区分是问诊点 |
| eczema | 湿疹 | 词库已有，cz 无 ae |
| bloated / bloating | 腹胀的 / 腹胀 | 词库已有 |
| constipated / constipation | 便秘的 / 便秘 | 词库已有 |
| diarrhoea | 腹泻 | 词库已有，英式 oe |
| cramping | 绞痛（痉挛样） | 与 stabbing（刺痛）成对记 |
| pass wind | 排气（俗） | 新词，已入词库；smelly wind = 臭屁 |
| muscle relaxants | 肌肉松弛药 | Q18 答案 |
| Imodium (loperamide, 洛哌丁胺) | 止泻药商品名 | 新词，已入词库；外周 μ-opioid agonist（μ-阿片受体激动剂）|
| gastroscopy | 胃镜检查 | 新词，已入词库；lay 说法 "the tube down from the top" |
| barium enema | 钡剂灌肠 | 词库已有 |
| ulcer | 溃疡 | an ulcer 冠词线索 |

### 4.2 口语/习语（GP 问诊高频）

| 短语 | 中文 | 例句位置 |
|---|---|---|
| locum GP / standing in for | 代班全科医生 / 顶替 | 两篇开场白都有 |
| give or take | 上下不差多少 | three weeks, give or take a day |
| bouts of | 一阵阵发作 | bouts of wheezing（词库 07-04 批已收）|
| come and go | 时有时无 | 症状描述高频 |
| getting me down | 让我情绪低落 | work's been getting me down |
| what with... and that | 因为……之类的（含糊口语） | what with the mortgage and that |
| get to the bottom of it | 查个水落石出 | Dr Brown can't get to the bottom of it |
| tummy | 肚子（儿语/口语） | 患者自述用词，笔记转写为 stomach |
| all in my head | 都是心理作用 | 功能性疾病咨询关键短语 |
| drawn a blank | 一无所获 | investigations have drawn a blank |
| rationalise (medications) | 精简合理化（用药） | 英式 -ise |
| keep an eye on | 密切观察 | safety-netting 用语 |
| spot it | 发现（病） | they didn't spot it（漏诊）|

---

## 五、关联

- 词库回填：[[OET_听力_默写词库]]「Part A 听力实战生词」2026-07-04 批（Imodium / wheezing / gastroscopy / pass wind）
- 听力总技巧：[[OET_听力阅读_技巧]]
- 跨学科：[[完整笔记/Peixuan分科笔记/pulmonary]]（asthma 问诊逻辑）· [[完整笔记/Peixuan分科笔记/GI]]（IBS 诊断标准）· [[完整笔记/Peixuan分科笔记/psych]]（somatic symptom disorder 处理原则）
