---
title: ECFMG 跟进信（援引 Reference Guide + 请求改 school of record）
type: 申请追踪
created: 2026-06-24
status: 待发送
---
...
> **全程属实、不替对方挑刺、不撒谎**（临床见习 2024 已如实披露，以协和成绩单为准，此信不重复不回避）。

---

## 发送信息

- **收件人**：回复你 6/19 那封原邮件线程（发给 ECFMG / info）；**并**在 **MyIntealth → My Cases** 同步提交
- **主题**：`Follow-up — Eligibility via Doctor of Clinical Medicine (PUMC, 2012); request to update medical school of record — ID 1-190-034-7 (Cases C-27107384 / C-27110565)`
- **附件**：博士学位证（CDGDC 英译 + 原件）、执业证、副高证、CV（见 [[05_资质文件清单]]）
...
I am writing to follow up on my email of **June 19, 2026** (Cases **C-27107384 / C-27110565**), to which I have so far received only an automated acknowledgment. I would be very grateful for a substantive response, as this matter directly affects my ability to proceed.
...
I have also been a **licensed physician in China (Type: Clinical Medicine) since 2013**, and I practiced as an **attending pathologist (2014)** and **Deputy Chief Physician (2020)** at PUMC Hospital, signing out over 27,000 surgical pathology cases and more than 4,000 intraoperative consultations.

In light of the above, I respectfully request that ECFMG:
...
Sincerely,
**Yuan Li**
USMLE/ECFMG ID: **1-190-034-7**
MyIntealth ID: 601079276
liyuan721@gmail.com
**[电话]**
...
- [ ] `[电话]`
- [ ] 确认 MyIntealth ID（601079276，核对）

## 红线提醒（务必守住）

- ✅ 可以：不主动强调临床轮转量；只陈述真实有利事实
- ❌ 不能：谎称做过没做的临床轮转/经历 → 与协和成绩单对不上 = **irregular behavior → 可能永久禁申**
- 成绩单 ECFMG 直接向协和调，**隐瞒无用、撒谎致命**；本信只说真的。
