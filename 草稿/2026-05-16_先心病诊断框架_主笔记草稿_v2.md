...
> [!tip] 各病速查级详解 → 已有衍生
> 下方对照表是**框架定位用**（5 步法砍选项的依据）。每个病的"出生时间窗 / 关键 stem 触发词 / ECG / 治疗"完整速查见 [[完整笔记/专题笔记/_衍生_新生儿先心病系统化总结]] **Part 4.2**（紫绀型，含 Ebstein / 反向差异性 / PDA 维持机制）。
...
> [!tip] 各病速查级详解 → 已有衍生
> 下方两张表是**框架定位用**。每个病的完整速查（含 IDM-HCM / ALCAPA / Supravalvular AS / PFO / IAA / VSD 自然病程 4 阶段 / high-output HF 反直觉）见 [[完整笔记/专题笔记/_衍生_新生儿先心病系统化总结]] **Part 4.1**。
...
- 🔗 已有专题笔记：
  - [[完整笔记/专题笔记/_衍生_新生儿先心病系统化总结]]（时间 × 紫绀 × 杂音三轴 — 待整合时合并对照）
- 🏥 跨学科：
