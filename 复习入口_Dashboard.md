...
### W4-W10 评估排布（每周四一套，最预测的压最后）

```
W4 NBME13(6/25) │ W5 UWSA1 │ W6 NBME14 │ W7 UWSA2(强预测) │ W8 NBME15
W9 NBME16 + Free120#1 │ W10 Free120 #2/#3 + UWSA3 → 考试
```
（每个评估都落在当周**周四**，判分当天 + 次日逐题精析）
...
|---|---|---|---|---|---|
| 基线 | NBME 12 | — | 210 | — | 起点 |
| **2026-06-18(四)** | **NBME 11** | **65.5%** | **225** | **+15** | 新节奏首考；逐题精析 → [[NBME/nbme-records]] |
| 2026-06-25(四) | NBME 13 | — | — | — | 下次 ｜ W3 决策闸门（≥235 / <225）|

> [!tip] 距目标 250+ 还差 **25 分**
> 225 正好压在 **W3 决策闸门 225/235 边界**：6/25 的 NBME 13 ≥235 → 二刷走智能版、考期锁 8 月中；<225 或滞后 → 二刷只做错题+弱科、留 buffer 到 8 月底。
