...
> - 📚 主笔记：[[完整笔记/Peixuan分科笔记/psych]]
> - 🌱 TODO（待生成衍生）：
>   - 等再积累 2-3 道 mood/psychotic 鉴别错题 → 请 Claude Code 整合 → 生成 [[完整笔记/专题笔记/衍生/_衍生_Psychotic_Disorders决策树]]（覆盖 BPD / Schizophreniform / Schizophrenia / Schizoaffective / Delusional / Mood with psychotic features 的"时间 + 独立性"双维度鉴别）
>   - 等积累 Bipolar I/II / Cyclothymia / MDD 类错题 → 生成 [[完整笔记/专题笔记/衍生/_衍生_Mood_Disorders诊断标准]]（DIGFAST + 时间门槛 + 各 specifier）
>
> **✅ 复盘行动**
> - [ ] 1 周后重做（重点检验 C 的排除逻辑）
...
> - 🌱 TODO（待生成衍生）：等 psych + 药理副作用错题积累 3-4 道后，请 Claude Code 整合 "drug-induced 神经精神症状 + 通用 first-step（先撤致病药）" 类错题 → 生成 [[完整笔记/专题笔记/衍生/_衍生_药物源性精神神经副作用]]
>
> **9. ✅ 复盘行动**
> - [ ] 1 周后重做 Q16049
...
> - 🌱 TODO（待生成衍生）：等 Ethics + Psych 章节复习完，请 Claude Code 整合「UDS 假阳性」「医患沟通『先验证再行动』原则」「医生保密 vs 上报义务」类错题 → 生成 [[完整笔记/专题笔记/衍生/_衍生_医患沟通行动顺序]]（核心：确证优先 / 温和半行动陷阱 / 保密边界）
>
> **9. ✅ 复盘行动**
...
> - 🌱 TODO（待生成衍生）：等 psych 抗精神病药章节复习完，请 Claude Code 整合 [EPS 四兄弟（时间线+表现+治疗）+ SGA/FGA TD 风险分层] 类错题 → 生成 [[完整笔记/专题笔记/衍生/_衍生_抗精神病药EPS四兄弟鉴别]]
>
> **9. ✅ 复盘行动**
...
> - 🌱 TODO（待生成衍生）：
>   - 等神经 MS 章节复习完 → Claude Code 整合「MS 各系统表现 + 鉴别(TIA/seizure/migraine/conversion) + 精神并发症」→ 生成 [[完整笔记/专题笔记/衍生/_衍生_MS全景图与误诊陷阱]]
>   - 等 psych 积累后 → 整合「Depressive disorder due to another medical condition（MS/帕金森/卒中/甲减等继发抑郁）」→ 生成 [[完整笔记/专题笔记/衍生/_衍生_继发性抑郁的内科病因]]
>
> **9. ✅ 复盘行动**
...
> - 🌱 TODO（待生成衍生）：等 Psych / Neuro 老年章节复习完，请 Claude Code 整合"老年认知/功能下降可逆病因 DDx（听/视/抑/药/甲/B12）+ 评估先简单后昂贵 SOP"类错题 → 生成 [[完整笔记/专题笔记/衍生/_衍生_老年认知功能下降可逆病因DDx]]
>
> ## 9. ✅ 复盘行动
> - [ ] 1 周后重做 Q19477
...
> - 🌱 TODO（待生成衍生）：等 Psych 章节复习完，请 Claude Code 整合"自杀/自伤"类错题（风险 vs 保护因子排序 + NSSI vs attempt + SSRI 黑框 + bipolar 家族史筛查）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_自杀风险评估]]
>
> ## 9. ✅ 复盘行动
> - [ ] 1 周后重做 Q2517
...
> - 🏥 跨学科：（无，本题为纯精神科管理流程题）
> - 🌱 TODO（待生成衍生）：
>   - 等 psych 抑郁/急症章节复习完 → Claude Code 整合「精神科 next-step 管理顺序」类错题（自杀评估优先 / 抑郁先评估安全再开药 / 躁狂先排器质 / 急症处置门槛）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_精神科next-step决策树]]
>   - 「自杀风险评估与处置」素材已够（Q2360 成人门诊 + Q15895 儿童急诊住院）→ Claude Code 整合时**必须包含成人 vs 儿童的处置门槛对照** → 生成 [[完整笔记/专题笔记/衍生/_衍生_自杀风险分级与处置]]
>
> **9. ✅ 复盘行动**
...
> - 🌱 TODO（待生成衍生）：等 psych 抗抑郁药章节复习完，请 Claude Code 整合「抗抑郁药非抑郁适应症」类错题（duloxetine→神经痛、bupropion→戒烟、mirtazapine→食欲↑/助眠、trazodone→助眠、SSRI→焦虑/OCD/PTSD）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_抗抑郁药一药多用对照表]]
>
> **9. ✅ 复盘行动**
> - [ ] 1 周后重做（盖答案，先找"第二个病"）
...
> - 🌱 TODO（待生成衍生）：等 psych 抑郁章节复习完，请 Claude Code 整合「MDD 亚型(atypical/melancholic) + 抑郁谱系病程鉴别(normal/adjustment/MDD/dysthymia) + substance-induced 剂量判断」三类错题 → 生成 [[完整笔记/专题笔记/衍生/_衍生_抑郁谱系鉴别决策树]]
>
> **9. ✅ 复盘行动**
...
> - 🌱 TODO（待生成衍生）：等 ethics 章节复习完，请 Claude Code 整合「未成年人医疗决策例外（精神科非自愿住院/性健康/物质滥用/急救/emancipated minor）+ 自主权 vs 安全保护义务 + 免责文书无效场景」三类错题 → 生成 [[完整笔记/专题笔记/衍生/_衍生_未成年人同意与非自愿住院决策树]]
>
> **9. ✅ 复盘行动**
...
> - 🌱 TODO（待生成衍生）：等 psych 章节复习完，请 Claude Code 整合 [抗抑郁药副作用 + 双相急性期处理 + "drug-induced 先撤药" first-step 类错题] → 生成 [[完整笔记/专题笔记/衍生/_衍生_drug-induced急性事件first-step]]（如已建则并入）
>
> **9. ✅ 复盘行动**
...
> - 🏥 跨学科：（无特别跨科关联）
> - 🌱 TODO（待生成衍生）：等 psych 章节复习完，请 Claude Code 整合"急性激越/不配合患者的即刻处理"类错题（acute mania / acute psychosis / agitation in dementia 等）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_急性激越处理决策树]]（强调：给药途径 + 起效速度 + 配合度 三要素）
>
> **9. ✅ 复盘行动**
> - [ ] 1 周后重做此题
...
> - 📚 主笔记：[[完整笔记/Peixuan分科笔记/psych]]
> - 🏥 跨学科：（无明显跨学科关联）
> - 🌱 TODO（待生成衍生）：等 psych 章节积累 3-4 道「情绪障碍鉴别(PDD/MDD/adjustment/double depression)」+「人格障碍鉴别(avoidant/dependent/borderline)」错题后，请 Claude Code 整合 → 生成 [[完整笔记/专题笔记/衍生/_衍生_抑郁谱系鉴别决策树]] 与 [[完整笔记/专题笔记/衍生/_衍生_人格障碍鉴别]]
>
> **9. ✅ 复盘行动**
> - [ ] 1 周后重做 Q4816
...
> - 🌱 TODO（待生成衍生）：
>   - 等 psych+ethics 复习完，请 Claude Code 整合「医患沟通措辞题」类错题 → 生成 [[完整笔记/专题笔记/衍生/_衍生_医患沟通措辞题SOP]]
>   - 积累 3-4 道黑框警告题后整合 → 生成 [[完整笔记/专题笔记/衍生/_衍生_FDA黑框警告速查]]
>
> **9. ✅ 复盘行动**
> - [ ] 1 周后重做 Q7289
> - [ ] 默写黑框警告 6 维度速查表
...
> - 🏥 跨学科：无（纯精神科用药决策）
> - 🌱 TODO（待生成衍生）：
>   - 等 psych 章节复习完，请 Claude Code 整合「抑郁联合用药决策」类错题（精神病性抑郁 / 难治性增效 / 单药失败升级 / ECT 指征）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_抑郁联合用药决策树]]
>   - 整合「Lithium 多重身份」相关错题（增效 / 双相 / 抗自杀）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_精神科增效策略]]
>
> **9. ✅ 复盘行动**
> - [ ] 1 周后重做 Q15088
...
> - 🌱 TODO（待生成衍生）：等 psych 章节复习完，请 Claude Code 整合「ECT 适应证 + MDD 治疗升级路径（普通 MDD → treatment-resistant → psychotic features → 急迫情况）+ 抗精神病/抗抑郁药选择陷阱」→ 生成 [[完整笔记/专题笔记/衍生/_衍生_精神科治疗决策树]]
>
> **9. ✅ 复盘行动**
> - [ ] 1 周后重做这题
...
> - 🌱 TODO（待生成衍生）：等内分泌「垂体」+ 精神科「抗精神病药副作用」复习完，请 Claude Code 整合高泌乳素鉴别类错题（药物 vs 瘤 vs 甲减 vs 肾病，含 100 ng/mL 阈值表）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_高泌乳素鉴别]]
>
> **9. ✅ 复盘行动**
...
> - 🌱 TODO（待生成衍生）：
>   - 等风湿/免疫「SLE」+ 精神科「急性精神病鉴别」复习完，请 Claude Code 整合「儿童/青少年急性精神病——继发器质病因鉴别决策树（SLE/甲状腺/代谢/物质/药物）」→ 生成 [[完整笔记/专题笔记/衍生/_衍生_儿童急性精神病鉴别]]
>   - 等 SLE 错题积累后，请 Claude Code 整合「自身抗体筛查顺序（ANA→dsDNA/Smith→补体）」→ 生成 [[完整笔记/专题笔记/衍生/_衍生_自身抗体鉴别]]
>
> **9. ✅ 复盘行动**
...
> - 🌱 TODO（待生成衍生）：等 neuro/psych 章节复习完，请 Claude Code 整合**药物诱导运动障碍类错题**（acute dystonia / akathisia / tardive dyskinesia / NMS / serotonin syndrome）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_药物诱导运动障碍鉴别]]
>
> **9. ✅ 复盘行动**
> - [ ] 1 周后重做 Q2505
...
> - 🌱 TODO（待生成衍生）：psych 章节复习完，请 Claude Code 整合**抗精神病药副作用+监测类错题**（Q4885 代谢 / Q16115 致癫痫 / ziprasidone QT / risperidone 泌乳素 / lithium 肾甲功）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_抗精神病药副作用对照]]（含"招牌副作用→该查什么"映射表）
>
> **9. ✅ 复盘行动**
> - [ ] 1 周后重做 Q4885
...
> - 🌱 TODO（待生成衍生）：psych 章节复习完，请 Claude Code 整合 **抗精神病药副作用类错题**（Q16115 致癫痫 / Q4885 代谢监测 / clozapine 三大监测 / EPS / ziprasidone QT / risperidone 泌乳素）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_抗精神病药副作用对照]]；另整合 **降低癫痫阈值药物** 错题 → 生成 [[完整笔记/专题笔记/衍生/_衍生_致癫痫药物清单]]
>
> **9. ✅ 复盘行动**
> - [ ] 1 周后重做 Q16115
...
> - 🌱 TODO（待生成衍生）：psych 章节复习完，请 Claude Code 整合 **四大 EPS 诊断+治疗类错题**（Q2505 dystonia / Q11898 akathisia / +未来 parkinsonism、TD）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_四大EPS诊断治疗对照]]（起病时间轴 + 治疗药物映射），与 [[完整笔记/专题笔记/衍生/_衍生_抗精神病药副作用对照]] 互补
>
> **9. ✅ 复盘行动**
> - [ ] 1 周后重做 Q11898
...
> - 🌱 TODO（待生成衍生）：等 psych 焦虑障碍章节复习完，整合儿童焦虑谱系（selective mutism / separation anxiety / SAD / specific phobia / stranger anxiety）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_儿童焦虑谱系鉴别]]
>
> ## ✅ 复盘行动
...
> - 🌱 TODO（待生成衍生）：等 psych 复习完，整合「高热 + 肌强直急症」（NMS / 5-HT 综合征 / malignant catatonia / malignant hyperthermia）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_高热肌强直急症鉴别]]（含各自实验室指纹 + 治疗 + ECT 是否适用）
>
> ## ✅ 复盘行动
...
> - 🌱 TODO（待生成衍生）：等 psych 章节复习完，请 Claude Code 整合「急性 vs 长期治疗时间维度错位」类错题（acute agitation / acute mania / status epilepticus / 急性 vs 维持降压 等跨科同构陷阱）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_急性vs长期治疗陷阱]]
>
> **✅ 复盘行动**
...
> - 📚 主笔记：[[完整笔记/Peixuan分科笔记/psych]]
> - 🏥 跨学科：（无明显跨学科，省略）
> - 🌱 TODO（待生成衍生）：等 psych 章节复习完，请 Claude Code 整合「抗精神病药剂型/适应症选择」类错题（PO vs IM vs LAI vs clozapine 时机、SGA vs FGA 取舍、nonadherence 处理）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_抗精神病药选择决策树]]
>
> **✅ 复盘行动**
...
> - 📚 主笔记：[[完整笔记/Peixuan分科笔记/psych]]
> - 🏥 跨学科：（无明显跨学科）
> - 🌱 TODO（待生成衍生）：等 psych 精神病性障碍章节复习完，请 Claude Code 整合「BPD / Schizophreniform / Schizophrenia / Delusional disorder + ASD/PTSD/Grief 鉴别」这批错题 → 生成 [[完整笔记/专题笔记/衍生/_衍生_精神病性障碍病程决策树]]
>
> **10. ✅ 复盘行动**
> - [ ] 1 周后重做（先判症状性质，再数病程）
...
> > - 📚 主笔记：[[完整笔记/Peixuan分科笔记/psych]]
> > - 🏥 跨学科：（无）
> > - 🌱 TODO（待生成衍生）：等 psych 章节积累 3+ 道心理治疗 / 精分管理错题后，请 Claude Code 整合 → 生成 [[完整笔记/专题笔记/衍生/_衍生_心理治疗鉴别速查]]（五种 psychotherapy 对照 + 适应症 + Stem 关键词 + 禁忌）
>
> **✅ 复盘行动**
> > - [ ] 1 周后重做本题
...
> > - 🌱 TODO（待生成衍生）：等 psych 章节积累 3+ 道"诊断 vs 先 workup / 急诊精神科首步"错题后，请 Claude Code 整合 → 生成 [[完整笔记/专题笔记/衍生/_衍生_新发精神病急诊处理SOP]]（new-onset psychosis 决策树 + 抗精神病药指征 + 各类精神病性障碍鉴别 + 既往史诱导陷阱）
>
> **✅ 复盘行动**
> > - [ ] 1 周后重做本题
...
> - 🌱 TODO（待生成衍生）：等 psych 章节复习完，请 Claude Code 整合「精神药物副作用 + 监测」类错题（Q4885 代谢 / Q16115 致癫痫 / Q12468 肝毒 / lithium 肾甲 / lamotrigine SJS / ziprasidone QT）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_精神科用药副作用对照]]（抗精神病药 + 心境稳定剂，含「招牌副作用 → 该查什么」映射）
>
> ## ✅ 复盘行动
...
> - 🌱 TODO（待生成衍生）：等 psych 复习完，请 Claude Code 整合四大 EPS 错题（Q2505 dystonia / Q11898 akathisia / Q16066 + Q2518 TD / 待补 parkinsonism）→ 生成 [[完整笔记/专题笔记/衍生/_衍生_四大EPS诊断治疗对照]]（起病时间轴 + 治疗药映射）
>
> ## ✅ 复盘行动
> - [ ] 默写四大 EPS 速查（起病时间 + 治疗）
...
> - 📚 主笔记：[[完整笔记/Peixuan分科笔记/psych]] / [[完整笔记/Peixuan分科笔记/neuro]]
> - 🏥 跨学科：[[完整笔记/专题笔记/衍生/_衍生_四大EPS诊断治疗对照]] §4.3（四大 EPS 体系完整版，本卡是 §4.3 锚点）
> - 🌱 TODO：已并入 [[完整笔记/专题笔记/衍生/_衍生_四大EPS诊断治疗对照]] §4.3
>
> ## ✅ 复盘行动
...
> - 📚 主笔记：[[完整笔记/Peixuan分科笔记/neuro]] / [[完整笔记/Peixuan分科笔记/psych]]
> - 🏥 跨学科：[[完整笔记/专题笔记/衍生/_衍生_四大EPS诊断治疗对照]] §4.3（四大 EPS 体系完整版）
> - 🌱 TODO：已并入 [[完整笔记/专题笔记/衍生/_衍生_四大EPS诊断治疗对照]] §4.3；后续积累 Parkinson-plus（PSP / MSA / CBD / DLB）题 → 单独建衍生
>
> ## ✅ 复盘行动
