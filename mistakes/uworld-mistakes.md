...
> - 📚 主笔记：[[完整笔记/Peixuan分科笔记/psych]] / [[完整笔记/专题笔记/psych_医患沟通对话术SOP]]
> - 🏥 跨学科：[[完整笔记/Peixuan分科笔记/消化腺]]（alcohol → LFT 升高 + HTN 恶化，本题躯体背景）
> - 🌱 TODO：MI 已积累 2 题，已生成 [[完整笔记/专题笔记/psych_医患沟通对话术SOP]]；后续补坏消息告知(SPIKES)/知情同意/患者拒绝治疗类错题继续整合进该专题。
>
> **9. ✅ 复盘行动**
...
> - 🌱 TODO：与 Q11936 共同构成 MI 错题对，已生成 [[完整笔记/专题笔记/psych_医患沟通对话术SOP]]；后续 change talk vs sustain talk 题继续补入。
>
> **9. ✅ 复盘行动**
...
> - 🌱 TODO（待生成衍生）：等 psych 物质滥用章节复习完，请 Claude Code 整合"各类滥用物质特征性体征鉴别"（AAS/Meth/PCP/大麻/阿片）→ 生成 [[完整笔记/专题笔记/psych_物质滥用体征鉴别表]]；并整合"男性 Gynecomastia 病因鉴别"→ 生成 [[完整笔记/专题笔记/内分泌_Gynecomastia鉴别]]
>
> **9. ✅ 复盘行动**
> - [ ] 1 周后重做（不看选项凭体征锁 AAS）
> - [ ] 默写 AAS 综合征 + 双路机制链
...
> - 📚 主笔记:[[完整笔记/Peixuan分科笔记/psych]]
> - 🏥 跨学科:暂无(纯精神科用药题)
> - 🌱 TODO:等 psych 章节复习完,请 Claude Code 整合「双相 I/II 鉴别 + 各相用药 + 抗抑郁药诱发躁狂 + 一代/二代抗精神病药适应症 + 各药监测禁忌」类错题 → 已整合为专题笔记 [[完整笔记/专题笔记/psych_双相障碍用药决策树]],后续按新错题升级版本
>
> **✅ 复盘行动**
> - [ ] 1周后重做(先判当前相再选药)
...
> - 📚 主笔记：[[完整笔记/Peixuan分科笔记/psych]]
> - 🏥 跨学科：[[完整笔记/Peixuan分科笔记/肾脏]]（拒食脱水 → decreased skin turgor / dry mucous membranes 是 hypovolemia 体征）；[[完整笔记/专题笔记/OB_GYN_孕期致畸药]]（妊娠用药受限是 ECT 选项的底层理由）
